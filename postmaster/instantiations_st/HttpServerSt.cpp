...
namespace main_
{
    HttpServerSt::HttpServerSt(services::ConnectionFactory& connectionFactory, services::ConfigurationStoreAccess<infra::BoundedString>& hostname,
        ...
        : HttpServer(connectionFactory, hostname, attributes, password, authentication, postmasterDiscovery, uartProgrammerCreator, uartExternalCreator, upgradeFlash, reset, reporter, receivingTarget, receivingSelf, resetTarget, boot0)
    {}
}
